import { TeacherMaxHoursPerDay } from './TeacherMaxHoursPerDay';
import { Activity } from '../../../models/Activity';
import { TimetableAssignment } from '../../../../scheduler/TimetableAssignment';

describe('TeacherMaxHoursPerDay', () => {
  let constraint: TeacherMaxHoursPerDay;
  ...
  beforeEach(() => {
    ...
    // constraint = new TeacherMaxHoursPerDay(...);
  });
