...
class TimetableAssignment {
  private activitySlots: Map<ActivityId, Period> = new Map(); 
  private activityRooms: Map<ActivityId, RoomId> = new Map(); 
  private timeIntervals: Map<PeriodInMinutes, Activity> = new Map(); 
  private roomTimeIntervals: Map<PeriodInMinutes, Activity> = new Map(); 
  constructor(
